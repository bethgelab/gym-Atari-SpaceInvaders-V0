...
class Agent:
  ...
  def test(self, test_steps, epoch = 0):
    ...
    for i in range(test_steps):
      ...
      obs_array.append(screen)
    
    np.save('/home/deba/gym/DqnAgent/neon/simple_dqn/results/game_videos/game{0:04d}'.format(epoch+2), obs_array)
    #self.mem.saveGame(epoch)    
  ...
  def play(self, num_games):
    ...
    ### DEBUG ###
    #obs_array = np.zeros((frame_no, 210, 160, 3))
